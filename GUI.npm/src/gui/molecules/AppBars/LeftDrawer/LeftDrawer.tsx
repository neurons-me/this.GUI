...
export type LeftDrawerProps = {
  ...
  // Styling passthroughs (granular)
  sx?: SxProps<Theme>;         // styles for the root <Drawer>
  paperSx?: SxProps<Theme>;    // styles for .MuiDrawer-paper
  listSx?: SxProps<Theme>;     // styles for the root <List>
  headerSx?: SxProps<Theme>;   // styles for the header container
  itemSx?: SxProps<Theme>;     // styles for top-level items
  nestedItemSx?: SxProps<Theme>; // styles for nested items
          ...
          <React.Fragment key={nodeId}>
            <ListItemButton
              ...
              sx={[
                ...
                ...(level > 2
                  ? (Array.isArray(nestedItemSx) ? nestedItemSx : nestedItemSx ? [nestedItemSx] : [])
