...
const lightTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light": { "$type": "color", "$value": "rgba(95, 168, 176, 0.25)" },
      "medium": { "$type": "color", "$value": "rgba(95, 168, 176, 0.4)" },
      "heavy": { "$type": "color", "$value": "rgba(95, 168, 176, 0.6)" },
      "all": { "$type": "color", "$value": "rgba(95, 168, 176, 0.75)" }
    }
  },
  "effects": {
    "shadow": {
