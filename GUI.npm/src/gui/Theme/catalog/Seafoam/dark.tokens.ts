...
const darkTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light":   { "$type": "color", "$value": "rgba(36, 76, 78, 0.25)" },
      "medium":  { "$type": "color", "$value": "rgba(36, 76, 78, 0.4)" },
      "heavy":   { "$type": "color", "$value": "rgba(36, 76, 78, 0.6)" },
      "all":     { "$type": "color", "$value": "rgba(36, 76, 78, 0.75)" }
    }
  },
  "effects": {
    "shadow": {
