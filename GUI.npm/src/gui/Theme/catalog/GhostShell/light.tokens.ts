...
const lightTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light": { "$type": "color", "$value": "rgba(255, 255, 255, 0.2)" },
      "medium": { "$type": "color", "$value": "rgba(255, 255, 255, 0.35)" },
      "heavy": { "$type": "color", "$value": "rgba(255, 255, 255, 0.55)" },
      "all": { "$type": "color", "$value": "rgba(240, 255, 250, 0.75)" }
    },
    "accent": {
