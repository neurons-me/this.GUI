...
const lightTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light": { "$type": "color", "$value": "rgba(255, 245, 250, 0.25)" },
      "medium": { "$type": "color", "$value": "rgba(255, 240, 245, 0.45)" },
      "heavy": { "$type": "color", "$value": "rgba(255, 235, 240, 0.65)" },
      "all": { "$type": "color", "$value": "rgba(255, 220, 230, 0.75)" }
    }
  },
  "effects": {
    "shadow": {
