...
const darkTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light": { "$type": "color", "$value": "rgba(25, 37, 36, 0.25)" },
      "medium": { "$type": "color", "$value": "rgba(25, 37, 36, 0.45)" },
      "heavy": { "$type": "color", "$value": "rgba(25, 37, 36, 0.6)" },
      "all": { "$type": "color", "$value": "rgba(25, 37, 36, 0.75)" }
    }
  },
  "effects": {
    "shadow": {
