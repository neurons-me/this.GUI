...
const darkTokens = {
  ...
  "color": {
    ...
    "blur": {
      "light": { "$type": "color", "$value": "rgba(90, 61, 154, 0.25)" }, // sutil brillo púrpura
      "medium": { "$type": "color", "$value": "rgba(90, 61, 154, 0.4)" }, // neblina gótica media
      "heavy": { "$type": "color", "$value": "rgba(90, 61, 154, 0.6)" }, // efecto de profundidad intensa
      "all": { "$type": "color", "$value": "rgba(90, 61, 154, 0.75)" } // atmósfera completa
    }
  },
  "effects": {
    "shadow": {
