...
// Prince Of Darkness Dark Theme Tokens — overrides applied on top of global.tokens.json
const darkTokens = {
  "id": "PrinceOfDarkness-dark",
  "$description": "Prince Of Darkness Dark Theme Tokens — overrides applied on top of global.tokens.json",
  "color": {
    "primary": {
      "$type": "color",
      "$value": "#90caf9"
