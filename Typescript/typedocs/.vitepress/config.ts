...
export default defineConfig({
  ...
  // api/ is committed TypeDoc output (a separate tool, not regenerated by this
  // build) — never let VitePress empty outDir or it wipes api/ too.
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'API', link: 'https://neurons-me.github.io/GUI/Typescript/typedocs/api/' },
    ],
    sidebar: [
      {
        text: 'Guide',
      ...
      },
      {
        text: 'API Reference',
        items: [
          { text: 'Overview', link: 'https://neurons-me.github.io/GUI/Typescript/typedocs/api/' },
        ],
      },
    ],
    socialLinks: [
