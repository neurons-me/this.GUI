...
`,
  ...
  argTypes: {
    name: {
      control: 'text',
      description: 'Icon name token. Use prefixes like `lucide:`, `mui:`, or just the name for Material Symbols.',
    },
    iconColor: {
      control: 'color',
...
export const AllRegistries: Story = {
  ...
  render: () => (
    <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 28, alignItems: 'start' }}>
