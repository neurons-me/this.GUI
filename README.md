...
<table width="540" cellpadding="0" cellspacing="0" style="border:1px solid #30363d;border-radius:12px;overflow:hidden;background:#0d1117;font-family:sans-serif;margin:0 auto;">
  <tr>
    <td colspan="3" style="background:#161b22;padding:8px 12px;border-bottom:1px solid #30363d;">
      ...
      &nbsp;&nbsp;
      <code style="color:#8b949e;font-size:11px;">this.gui — components</code>
    </td>
  </tr>
  <tr>
    <td width="44" valign="top" style="background:#161b22;border-right:1px solid #30363d;padding:12px 6px;">
      <div style="width:28px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
      <div style="width:20px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
      <div style="width:24px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
    ...
    <td width="120" valign="top" style="background:#161b22;border-left:1px solid #30363d;padding:12px 8px;">
      <div style="width:90px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
      <div style="width:70px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
      <div style="width:80px;height:4px;background:#30363d;border-radius:2px;margin-bottom:6px;"></div>
      <div style="width:60px;height:4px;background:#30363d;border-radius:2px;"></div>
    </td>
  </tr>
</table>
</div>
