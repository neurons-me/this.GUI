  ...
  >
    ...
    >
      ...
      <Typography sx={{ maxWidth: 640, fontSize: '1.1rem', lineHeight: 1.4, mb: 3 }}>
        made by neurons.me in Veracruz.
      </Typography>
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5}>
        <Button variant="contained" color="primary" startIcon={<Icon name="auto_awesome" />}>
          window.GUI 
        </Button>
        <Button variant="outlined" color="secondary" component={Link} href="https://neurons.me">
          Visit neurons.me
        </Button>
      </Stack>
    </Box>
