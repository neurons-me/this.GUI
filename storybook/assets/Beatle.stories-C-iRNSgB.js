...
| 'streaming'
| 'error'
| 'disconnected'`,elements:[{name:"literal",value:"'idle'"},{name:"literal",value:"'parsing'"},{name:"literal",value:"'connecting'"},{name:"literal",value:"'resolving'"},{name:"literal",value:"'connected'"},{name:"literal",value:"'streaming'"},{name:"literal",value:"'error'"},{name:"literal",value:"'disconnected'"}],required:!0}},{key:"channelId",value:{name:"string",required:!1}},{key:"audience",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!1}},{key:"surface",value:{name:"string",required:!1},description:"Overlay/projection surface, not the NRP technical monad selector."},{key:"capabilities",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!1}},{key:"disclosure",value:{name:"union",raw:"'public' | 'opened' | 'closed' | 'contested'",elements:[{name:"literal",value:"'public'"},{name:"literal",value:"'opened'"},{name:"literal",value:"'closed'"},{name:"literal",value:"'contested'"}],required:!1},description:"Disclosure level reported by the NRP server for this channel"},{key:"error",value:{name:"string",required:!1}}]}},name:"channel"}],return:{name:"void"}}},description:""},onMessage:{required:!1,tsType:{name:"signature",type:"function",raw:"(msg: BeatleMessage) => void",signature:{arguments:[{type:{name:"union",raw:`| MsgNrpOpen
| MsgResolved
| MsgData
| MsgStream
| MsgRead
...
This is distinct from an NRP [monad] selector.`},{key:"disclosure",value:{name:"union",raw:"'public' | 'opened' | 'closed' | 'contested'",elements:[{name:"literal",value:"'public'"},{name:"literal",value:"'opened'"},{name:"literal",value:"'closed'"},{name:"literal",value:"'contested'"}],required:!0}}]},required:!0}},{key:"timestamp",value:{name:"number",required:!0}}]}},{name:"signature",type:"object",raw:`{
  ...
  payload: string;
  timestamp: number;
}`,signature:{properties:[{key:"type",value:{name:"literal",value:"'error'",required:!0}},{key:"channelId",value:{name:"string",required:!1}},{key:"payload",value:{name:"string",required:!0}},{key:"timestamp",value:{name:"number",required:!0}}]}},{name:"signature",type:"object",raw:"{ type: 'ping'; timestamp: number }",signature:{properties:[{key:"type",value:{name:"literal",value:"'ping'",required:!0}},{key:"timestamp",value:{name:"number",required:!0}}]}},{name:"signature",type:"object",raw:"{ type: 'pong'; timestamp: number }",signature:{properties:[{key:"type",value:{name:"literal",value:"'pong'",required:!0}},{key:"timestamp",value:{name:"number",required:!0}}]}}]},name:"msg"}],return:{name:"void"}}},description:""},onDisconnect:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},variant:{required:!1,tsType:{name:"union",raw:"'bar' | 'bubble'",elements:[{name:"literal",value:"'bar'"},{name:"literal",value:"'bubble'"}]},description:"",defaultValue:{value:"'bar'",computed:!1}},sx:{required:!1,tsType:{name:"any"},description:""}}};const Ee=[{namespace:"jabellae",kind:"monad",online:!0,endpoint:"http://127.0.0.1:4021",trust:"owner"},{namespace:"alex",kind:"monad",online:!0,endpoint:"http://127.0.0.1:4022"},{namespace:"team.acme",kind:"monad",online:!1,endpoint:"http://127.0.0.1:4023"},{namespace:"local.netget",kind:"netget",online:!0}],Br={title:"All.This/NRP/Beatle",component:b,parameters:{layout:"padded"}},C={render:()=>t.jsxs(E,{sx:{maxWidth:480,display:"flex",flexDirection:"column",gap:2},children:[t.jsx(q,{variant:"caption",sx:{color:"text.secondary"},children:"Type a .me expression and press Enter to open a WebSocket channel via NRP."}),t.jsx(b,{defaultExpression:"jabellae"}),t.jsx(b,{defaultExpression:"jabellae + alex"}),t.jsx(b,{})]})},A={render:()=>t.jsxs(E,{sx:{display:"flex",gap:3,alignItems:"center"},children:[t.jsx(b,{variant:"bubble",defaultExpression:"jabellae"}),t.jsx(b,{variant:"bubble"})]})},L={parameters:{layout:"fullscreen"},render:()=>t.jsx(ce,{TopBar:{title:"NRP",elementsRight:[{type:"action",props:{element:t.jsx(b,{sx:{width:320}})}}]},LeftBar:{elements:[{type:"link",props:{label:"Namespaces",icon:"hub"}},{type:"link",props:{label:"Channels",icon:"bolt"}},{type:"link",props:{label:"Mesh",icon:"polyline"}}]},RightBar:!1,Footer:!1,children:t.jsxs(E,{sx:{p:4,maxWidth:680,display:"flex",flexDirection:"column",gap:4},children:[t.jsxs(E,{children:[t.jsx(q,{variant:"h5",sx:{fontWeight:700,mb:.5},children:"Beatle"}),t.jsx(q,{variant:"body2",color:"text.secondary",children:"The NRP channel interface. Type any .me expression — a single namespace, a union, an intersection — and Beatle opens a bidirectional WebSocket to the resolved endpoint(s). The browser URL stays independent."})]}),t.jsx(b,{defaultExpression:"jabellae"}),t.jsx(E,{sx:{display:"flex",flexDirection:"column",gap:.75},children:["me://jabellae","me://jabellae + alex","me://jabellae ∩ team.acme","me://jabellae @ wikipedia.com",'me://(jabellae + alex) @ "https://wikipedia.com/Scarab"'].map(r=>t.jsx(q,{variant:"caption",sx:{color:"text.secondary",fontFamily:"monospace",fontSize:"0.72rem"},children:r},r))}),t.jsx(pe,{rows:Ee})]})})};var _,V,K;C.parameters={...C.parameters,docs:{...(_=C.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => <Box sx={{
    maxWidth: 480,
    display: 'flex',
...
}`,...(K=(V=C.parameters)==null?void 0:V.docs)==null?void 0:K.source}}};var H,J,G;A.parameters={...A.parameters,docs:{...(H=A.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: () => <Box sx={{
    display: 'flex',
    gap: 3,
    alignItems: 'center'
...
}`,...(G=(J=A.parameters)==null?void 0:J.docs)==null?void 0:G.source}}};var Y,Z,X;L.parameters={...L.parameters,docs:{...(Y=L.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  parameters: {
    layout: 'fullscreen'
  },
...
}`,...(X=(Z=L.parameters)==null?void 0:Z.docs)==null?void 0:X.source}}};const Tr=["Bar","Bubble","InLayout"];export{C as Bar,A as Bubble,L as InLayout,Tr as __namedExportsOrder,Br as default};
