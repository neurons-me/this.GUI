import{b as r,j as e,M as c}from"./iframe-BOpb4YIv.js";import"./preload-helper-Dp1pzeXC.js";function a(s){const n={blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",p:"p",pre:"pre",strong:"strong",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"All.This/NRP/Beatle/Contract"}),`
...
| `,e.jsx(n.code,{children:"closed"}),` | Namespace exists, caller has no access |
| `,e.jsx(n.code,{children:"stealth"}),` | Namespace does not reveal its own existence (A0/A2 axioms) |
| `,e.jsx(n.code,{children:"contested"})," | Multiple conflicting monads claim this namespace |"]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"stealth"})," is structural — the ",e.jsx(n.code,{children:".me"})," kernel never confirms existence of a secret scope root. Do not show existence hints to the user when ",e.jsx(n.code,{children:"disclosure === 'stealth'"}),"."]}),`
`,e.jsx(n.hr,{}),`
...
`})})]})}function o(s={}){const{wrapper:n}={...r(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{o as default};
