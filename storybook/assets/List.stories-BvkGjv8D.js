import{f as G,g as E,r as F,aW as H,j as e,aY as _,b0 as T,aZ as $,a_ as O,a$ as J}from"./iframe-DC1i1573.js";import{L as o}from"./List-CMjy8ixu.js";import{L as b}from"./ListItem-BmkNBzwH.js";import{L as g}from"./ListItemIcon-ZanOEmyx.js";import{L as h}from"./ListItemText-B84pw0of.js";import{I as x}from"./Icon-CuVJ4y2k.js";import"./preload-helper-Dp1pzeXC.js";import"./List-B4pOZQnr.js";import"./ListContext-DNDBaubu.js";import"./ListItem-B7H1ZlXZ.js";import"./isHostComponent-DVu5iVWx.js";import"./isMuiElement-DBFoehvw.js";import"./useForkRef-hpkiJGPF.js";import"./listItemIconClasses-BwKUXR3I.js";import"./listItemTextClasses-CTxYf6qB.js";import"./useSlot-D_8lZxqR.js";import"./resolveComponentProps-C5BoffGy.js";function Y(r){return G("MuiListSubheader",r)}E("MuiListSubheader",["root","colorPrimary","colorInherit","gutters","inset","sticky"]);const Z=r=>{const{classes:s,color:t,disableGutters:a,inset:u,disableSticky:m}=r,i={root:["root",t!=="default"&&`color${T(t)}`,!a&&"gutters",u&&"inset",!m&&"sticky"]};return $(i,Y,s)},q=O("li",{name:"MuiListSubheader",slot:"Root",overridesResolver:(r,s)=>{const{ownerState:t}=r;return[s.root,t.color!=="default"&&s[`color${T(t.color)}`],!t.disableGutters&&s.gutters,t.inset&&s.inset,!t.disableSticky&&s.sticky]}})(J(({theme:r})=>({boxSizing:"border-box",lineHeight:"48px",listStyle:"none",color:(r.vars||r).palette.text.secondary,fontFamily:r.typography.fontFamily,fontWeight:r.typography.fontWeightMedium,fontSize:r.typography.pxToRem(14),variants:[{props:{color:"primary"},style:{color:(r.vars||r).palette.primary.main}},{props:{color:"inherit"},style:{color:"inherit"}},{props:({ownerState:s})=>!s.disableGutters,style:{paddingLeft:16,paddingRight:16}},{props:({ownerState:s})=>s.inset,style:{paddingLeft:72}},{props:({ownerState:s})=>!s.disableSticky,style:{position:"sticky",top:0,zIndex:1,backgroundColor:(r.vars||r).palette.background.paper}}]}))),y=F.forwardRef(function(s,t){const a=H({props:s,name:"MuiListSubheader"}),{className:u,color:m="default",component:i="li",disableGutters:C=!1,disableSticky:N=!1,inset:z=!1,...A}=a,S={...a,color:m,component:i,disableGutters:C,disableSticky:N,inset:z},D=Z(S);return e.jsx(q,{as:i,className:_(D.root,u),ref:t,ownerState:S,...A})});y&&(y.muiSkipListHighlight=!0);const ue={title:"Molecules/List/List",component:o,tags:["autodocs"],decorators:[r=>e.jsx("div",{style:{padding:16,minHeight:260,maxWidth:560},children:e.jsx(r,{})})],parameters:{docs:{description:{component:`
