import{i as G,h as E,r as F,V as H,j as e,W as O,aV as T,X as V,Y as _,Z as $}from"./iframe-CP9CNxx8.js";import{L as o}from"./List-Db7iTkEX.js";import{L as b}from"./ListItem-BfokA4dE.js";import{L as h}from"./ListItemIcon-1zpiHevt.js";import{L as g}from"./ListItemText-CddPeRgJ.js";import{I as x}from"./Icon-BnIUx9th.js";import"./preload-helper-Dp1pzeXC.js";import"./List-dcxI-oUi.js";import"./ListContext-BdVLFpgb.js";import"./ListItem-DPf-JTMm.js";import"./isHostComponent-DVu5iVWx.js";import"./isMuiElement-D1oDpjpb.js";import"./useForkRef-DbsbHXzv.js";import"./listItemIconClasses-t_-ds97q.js";import"./listItemTextClasses-DLUOdunC.js";import"./useSlot-Mh1rGqki.js";import"./resolveComponentProps-ClcYrv8r.js";function J(r){return G("MuiListSubheader",r)}E("MuiListSubheader",["root","colorPrimary","colorInherit","gutters","inset","sticky"]);const X=r=>{const{classes:s,color:t,disableGutters:a,inset:u,disableSticky:m}=r,i={root:["root",t!=="default"&&`color${T(t)}`,!a&&"gutters",u&&"inset",!m&&"sticky"]};return V(i,J,s)},Y=_("li",{name:"MuiListSubheader",slot:"Root",overridesResolver:(r,s)=>{const{ownerState:t}=r;return[s.root,t.color!=="default"&&s[`color${T(t.color)}`],!t.disableGutters&&s.gutters,t.inset&&s.inset,!t.disableSticky&&s.sticky]}})($(({theme:r})=>({boxSizing:"border-box",lineHeight:"48px",listStyle:"none",color:(r.vars||r).palette.text.secondary,fontFamily:r.typography.fontFamily,fontWeight:r.typography.fontWeightMedium,fontSize:r.typography.pxToRem(14),variants:[{props:{color:"primary"},style:{color:(r.vars||r).palette.primary.main}},{props:{color:"inherit"},style:{color:"inherit"}},{props:({ownerState:s})=>!s.disableGutters,style:{paddingLeft:16,paddingRight:16}},{props:({ownerState:s})=>s.inset,style:{paddingLeft:72}},{props:({ownerState:s})=>!s.disableSticky,style:{position:"sticky",top:0,zIndex:1,backgroundColor:(r.vars||r).palette.background.paper}}]}))),y=F.forwardRef(function(s,t){const a=H({props:s,name:"MuiListSubheader"}),{className:u,color:m="default",component:i="li",disableGutters:C=!1,disableSticky:N=!1,inset:z=!1,...A}=a,S={...a,color:m,component:i,disableGutters:C,disableSticky:N,inset:z},D=X(S);return e.jsx(Y,{as:i,className:O(D.root,u),ref:t,ownerState:S,...A})});y&&(y.muiSkipListHighlight=!0);const ue={title:"Molecules/List/List",component:o,tags:["autodocs"],decorators:[r=>e.jsx("div",{style:{padding:16,minHeight:260,maxWidth:560},children:e.jsx(r,{})})],parameters:{docs:{description:{component:`
