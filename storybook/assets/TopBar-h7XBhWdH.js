import{j as e,L as X,r as y,at as J,R as le,aV as pe,c as ue,ar as B}from"./iframe-uhZydg3N.js";import{I as M}from"./Icon-Di-oNoRg.js";import{M as ce}from"./Menu-BJsPtyM-.js";import{M as G}from"./MenuItem-BWLDfidd.js";import{Link as me}from"./index-Cc8CasjX.js";import{u as O}from"./useGuiMediaQuery-bhoeUMQD.js";import{u as de,a as he}from"./useInsets-DEwD25dx.js";import{A as ye}from"./Avatar-B6GTAajh.js";import{A as fe}from"./AppBar-Bl_jxp7l.js";import{T as ge}from"./Toolbar-BSFIxwSy.js";const _=({label:t,href:n,icon:r,iconColor:o,external:a,showLabel:i=!0})=>{const l=e.jsxs(e.Fragment,{children:[r&&e.jsx(M,{name:r,iconColor:o||"currentColor",style:{marginRight:3,fontSize:20,position:"relative",top:-1}}),i&&e.jsx("span",{children:t})]});return e.jsx(X,{href:n??"#",target:a?"_blank":"_self",style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none"},children:l})};_.__docgenInfo={description:"",methods:[],displayName:"TopBarLink",props:{label:{required:!0,tsType:{name:"string"},description:""},href:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"string"},description:""},external:{required:!1,tsType:{name:"boolean"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon. Defaults to true.",defaultValue:{value:"true",computed:!1}}}};const K=(t,n,r,o)=>t.map(({label:a,href:i,icon:l,iconColor:h,external:m,items:f},T)=>{const v=a??i??T,u=r.has(a),g=e.jsxs(X,{to:m?void 0:i,href:m?i:void 0,target:m?"_blank":void 0,style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none",flexGrow:1},children:[l&&e.jsx(M,{name:typeof l=="string"?l:"info",iconColor:h||"currentColor",style:{marginRight:2,fontSize:20,position:"relative",top:-1}}),a]});return f&&f.length>0?e.jsxs(le.Fragment,{children:[e.jsxs(G,{onClick:()=>o(a),sx:{color:"inherit",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[g,e.jsx(M,{name:u?"expand_less":"expand_more",iconColor:"currentColor",style:{fontSize:20,position:"relative",top:-1,marginLeft:1}})]}),e.jsx("div",{style:{maxHeight:u?"500px":"0px",opacity:u?1:0,overflow:"hidden",transition:"max-height 0.2s ease-out, opacity 0.2s ease-out",paddingLeft:16},children:K(f,n,r,o)})]},v):e.jsx(G,{onClick:n,sx:{color:"inherit"},children:g},v)}),S=({label:t,icon:n,iconColor:r,items:o,showLabel:a=!0})=>{const[i,l]=y.useState(null),[h,m]=y.useState(new Set),f=u=>{l(u.currentTarget)},T=()=>{l(null),m(new Set)},v=u=>{m(g=>{const k=new Set(g);return k.has(u)?k.delete(u):k.add(u),k})};return e.jsxs(e.Fragment,{children:[e.jsxs(J,{onClick:f,sx:{cursor:"pointer",px:1,display:"inline-flex",alignItems:"center",color:"inherit"},children:[n&&e.jsx(M,{name:typeof n=="string"?n:"info",iconColor:r||"currentColor",style:{marginRight:a?2:0,fontSize:20,position:"relative",top:-1}}),a&&e.jsx("span",{children:t})]}),e.jsx(ce,{anchorEl:i,open:!!i,onClose:T,sx:{color:"inherit"},children:o&&K(o,T,h,v)})]})};S.__docgenInfo={description:"",methods:[],displayName:"TopBarMenu",props:{label:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon in the top-level menu trigger. Defaults to true.",defaultValue:{value:"true",computed:!1}},items:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  href: string;
  icon?: ReactNode;
  iconColor?: string;
