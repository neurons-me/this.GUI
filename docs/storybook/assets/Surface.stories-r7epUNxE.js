...
| 'outlined'
| 'glass'
| 'card'`,elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'elevation'"},{name:"literal",value:"'solid'"},{name:"literal",value:"'outline'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'glass'"},{name:"literal",value:"'card'"}]},description:"Visual style for the surface.\n`default`/`elevation` map to the standard solid paper surface."},color:{required:!1,tsType:{name:"unknown"},description:""}},composes:["Omit"]};const X={title:"Atoms/Surface",component:r,tags:["autodocs"],parameters:{layout:"centered",decorators:[t=>e.jsx(b,{children:e.jsx(t,{})})],docs:{description:{component:`
...
}`,...(u=(d=s.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const Y=["Variants"];export{s as Variants,Y as __namedExportsOrder,X as default};
