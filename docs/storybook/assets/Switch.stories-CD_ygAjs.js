import{h as K,i as Q,r as w,d as X,b as B,j as e,e as T,aT as U,f as Y,s as R,m as D,B as d,a as s}from"./iframe-8EaQ1C0g.js";import"./Button-Ck1yJXlA.js";import"./Paper-qkABWcDk.js";import{S as i}from"./Stack-w3FurTvB.js";import{S as r}from"./Switch-sWLClY08.js";import{f as Z}from"./formControlState-Dq1zat_P.js";import{u as ee}from"./useSlot-Bwp2wfPo.js";import{u as te}from"./useFormControl-BGPHKa-w.js";import"./preload-helper-Dp1pzeXC.js";import"./Icon-DOcDJgdS.js";import"./Button-CqN9UM-9.js";import"./ButtonBase-DnuzHV0k.js";import"./TransitionGroupContext-BDq06VYZ.js";import"./useForkRef-B_8DPUN9.js";import"./CircularProgress-CF5CFykq.js";import"./Paper-Cnfm5CEA.js";import"./getThemeProps-Cnx6th0B.js";import"./useControlled-ChLN6U0A.js";function oe(t){return K("MuiFormControlLabel",t)}const m=Q("MuiFormControlLabel",["root","labelPlacementStart","labelPlacementTop","labelPlacementBottom","disabled","label","error","required","asterisk"]),re=t=>{const{classes:o,disabled:l,labelPlacement:a,error:f,required:C}=t,S={root:["root",l&&"disabled",`labelPlacement${U(a)}`,f&&"error",C&&"required"],label:["label",l&&"disabled"],asterisk:["asterisk",f&&"error"]};return Y(S,oe,o)},ae=R("label",{name:"MuiFormControlLabel",slot:"Root",overridesResolver:(t,o)=>{const{ownerState:l}=t;return[{[`& .${m.label}`]:o.label},o.root,o[`labelPlacement${U(l.labelPlacement)}`]]}})(D(({theme:t})=>({display:"inline-flex",alignItems:"center",cursor:"pointer",verticalAlign:"middle",WebkitTapHighlightColor:"transparent",marginLeft:-11,marginRight:16,[`&.${m.disabled}`]:{cursor:"default"},[`& .${m.label}`]:{[`&.${m.disabled}`]:{color:(t.vars||t).palette.text.disabled}},variants:[{props:{labelPlacement:"start"},style:{flexDirection:"row-reverse",marginRight:-11}},{props:{labelPlacement:"top"},style:{flexDirection:"column-reverse"}},{props:{labelPlacement:"bottom"},style:{flexDirection:"column"}},{props:({labelPlacement:o})=>o==="start"||o==="top"||o==="bottom",style:{marginLeft:16}}]}))),le=R("span",{name:"MuiFormControlLabel",slot:"Asterisk",overridesResolver:(t,o)=>o.asterisk})(D(({theme:t})=>({[`&.${m.error}`]:{color:(t.vars||t).palette.error.main}}))),n=w.forwardRef(function(o,l){const a=X({props:o,name:"MuiFormControlLabel"}),{checked:f,className:C,componentsProps:S={},control:p,disabled:N,disableTypography:A,inputRef:ie,label:W,labelPlacement:$="end",name:ne,onChange:ce,required:q,slots:O={},slotProps:_={},value:de,...V}=a,u=te(),v=N??p.props.disabled??(u==null?void 0:u.disabled),k=q??p.props.required,P={disabled:v,required:k};["checked","name","onChange","value","inputRef"].forEach(g=>{typeof p.props[g]>"u"&&typeof a[g]<"u"&&(P[g]=a[g])});const G=Z({props:a,muiFormControl:u,states:["error"]}),h={...a,disabled:v,labelPlacement:$,required:k,error:G.error},j=re(h),H={slots:O,slotProps:{...S,..._}},[J,b]=ee("typography",{elementType:B,externalForwardedProps:H,ownerState:h});let c=W;return c!=null&&c.type!==B&&!A&&(c=e.jsx(J,{component:"span",...b,className:T(j.label,b==null?void 0:b.className),children:c})),e.jsxs(ae,{className:T(j.root,C),ownerState:h,ref:l,...V,children:[w.cloneElement(p,P),k?e.jsxs("div",{children:[c,e.jsxs(le,{ownerState:h,"aria-hidden":!0,className:j.asterisk,children:[" ","*"]})]}):c]})}),Le={title:"Atoms/Switch",component:r,tags:["autodocs"],decorators:[t=>e.jsx(d,{sx:{p:2},children:e.jsx(t,{})})],parameters:{docs:{description:{component:`
...
}`,...(I=(E=y.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};const ze=["Playground","Variants"];export{x as Playground,y as Variants,ze as __namedExportsOrder,Le as default};
