import{av as p,az as l,j as n}from"./iframe-Gv_pzp9r.js";import{u}from"./useInsets-bkRUJ-mh.js";import"./preload-helper-Dp1pzeXC.js";const e=()=>{var o;const t=p(),{mode:h,themeId:m}=l(),c=u();return n.jsx("pre",{style:{padding:16},children:n.jsx("code",{children:JSON.stringify({mode:h,themeId:m,palette:t.palette,fontFamily:(o=t.typography)==null?void 0:o.fontFamily,typography:t.typography,insets:c},null,2)})})},T={title:"GUI/Theme/Typography",component:e,tags:["autodocs"],parameters:{docs:{description:{component:`
...
}`,...(a=(r=e.parameters)==null?void 0:r.docs)==null?void 0:a.source},description:{story:"Story: CurrentThemeState\n\nThis Storybook story displays the current theme state injected via MUI's ThemeProvider\nalong with custom context values such as `mode` (from ThemeContext) and `insets` (from InsetsContext).\n\nThe output includes:\n- `mode`: Light/dark mode from the app's ThemeContext\n- `palette`: Full palette object from MUI's `createTheme`, including color tokens and UI actions\n- `insets`: Safe area insets (top/right/bottom/left) for layout padding/margin\n\nUseful for debugging how the current theme looks, understanding the applied color system,\nand ensuring injected context values are correctly picked up across the app.",...(d=(i=e.parameters)==null?void 0:i.docs)==null?void 0:d.description}}};const x=["TypographyThemeState"];export{e as TypographyThemeState,x as __namedExportsOrder,T as default};
