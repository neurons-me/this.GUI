import{aA as J,j as e,B as f,a as r}from"./iframe-BzW5L-sB.js";import{u as K}from"./useInsets-CcwpjqH7.js";import{B as k}from"./Button-B701r1T7.js";import"./preload-helper-Dp1pzeXC.js";import"./Icon-BWddFN6m.js";import"./Button-DrdkIVvT.js";import"./ButtonBase-DEfx69p-.js";import"./TransitionGroupContext-DBebgn_y.js";import"./useForkRef-BZw98wdx.js";import"./useEventCallback-0bk4YSZd.js";import"./CircularProgress-CqZnmEb2.js";const a=({children:n,sx:o,maxWidth:Y="100%",component:$="section",bgcolor:i,colorVariant:b,padding:x,height:v,marginTop:T,marginBottom:S,marginLeft:j,marginRight:R})=>{const t=K(),s=J(),D=p=>{if(!p)return!1;if(p.includes(".")){const F=p.split(".");let c=s.palette;for(const w of F)if(c&&w in c)c=c[w];else return!1;return!0}return p in s.palette};let d;return i?d=(D(i),i):b&&s.palette.section&&b in s.palette.section&&(d=s.palette.section[b]),e.jsx(f,{component:$,sx:{width:`calc(100vw - ${t.left+t.right}px)`,height:v||`calc(100vh - ${t.top+t.bottom}px)`,marginTop:T!==void 0?T:t.top,marginBottom:S!==void 0?S:t.bottom,marginLeft:j!==void 0?j:t.left,marginRight:R!==void 0?R:t.right,maxWidth:Y,padding:x!==void 0?x:{xs:2,sm:3,md:4},...d?{bgcolor:d}:{},...o},children:n})};a.__docgenInfo={description:"",methods:[],displayName:"Section",props:{id:{required:!1,tsType:{name:"string"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},sx:{required:!1,tsType:{name:"SxProps",elements:[{name:"Theme"}],raw:"SxProps<Theme>"},description:""},colorVariant:{required:!1,tsType:{name:"unknown"},description:""},bgcolor:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""},component:{required:!1,tsType:{name:"ReactElementType",raw:"React.ElementType"},description:"",defaultValue:{value:"'section'",computed:!1}},elevation:{required:!1,tsType:{name:"number"},description:""},padded:{required:!1,tsType:{name:"boolean"},description:""},centered:{required:!1,tsType:{name:"boolean"},description:""},"data-testid":{required:!1,tsType:{name:"string"},description:""},maxWidth:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:"",defaultValue:{value:"'100%'",computed:!1}},padding:{required:!1,tsType:{name:"union",raw:"number | string | Record<string, any>",elements:[{name:"number"},{name:"string"},{name:"Record",elements:[{name:"string"},{name:"any"}],raw:"Record<string, any>"}]},description:""},height:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},marginTop:{required:!1,tsType:{name:"union",raw:"number | string | Record<string, any>",elements:[{name:"number"},{name:"string"},{name:"Record",elements:[{name:"string"},{name:"any"}],raw:"Record<string, any>"}]},description:""},marginBottom:{required:!1,tsType:{name:"union",raw:"number | string | Record<string, any>",elements:[{name:"number"},{name:"string"},{name:"Record",elements:[{name:"string"},{name:"any"}],raw:"Record<string, any>"}]},description:""},marginLeft:{required:!1,tsType:{name:"union",raw:"number | string | Record<string, any>",elements:[{name:"number"},{name:"string"},{name:"Record",elements:[{name:"string"},{name:"any"}],raw:"Record<string, any>"}]},description:""},marginRight:{required:!1,tsType:{name:"union",raw:"number | string | Record<string, any>",elements:[{name:"number"},{name:"string"},{name:"Record",elements:[{name:"string"},{name:"any"}],raw:"Record<string, any>"}]},description:""}}};const de={title:"Atoms/Containers/Section",component:a,tags:["autodocs"],decorators:[n=>e.jsx("div",{style:{padding:0,minHeight:400},children:e.jsx(n,{})})],parameters:{docs:{description:{component:`
...
}`,...(C=(q=m.parameters)==null?void 0:q.docs)==null?void 0:C.source}}};var V,P,A;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: args => <Box sx={{
    display: 'grid',
    gap: 2
  }}>
...
}`,...(A=(P=g.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};var E,I,M;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    padding: 4,
    bgcolor: '#2fb0a3ff'
  },
...
}`,...(M=(I=l.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var N,W,_;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(U=(G=h.parameters)==null?void 0:G.docs)==null?void 0:U.source}}};const pe=["Playground","Variants","CustomBackground","WithContentComposition","ResponsivePadding","ResponsiveMargins"];export{l as CustomBackground,m as Playground,h as ResponsiveMargins,y as ResponsivePadding,g as Variants,u as WithContentComposition,pe as __namedExportsOrder,de as default};
