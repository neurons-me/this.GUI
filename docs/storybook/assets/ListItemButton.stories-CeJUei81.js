import{r as u,c as Z,aZ as q,j as t,d as O,e as K,s as Q,a_ as X,m as Y,f as x}from"./iframe-B26CALAz.js";import{L as P}from"./ListContext-btDJ5CVO.js";import{g as ee,l as c,L as te}from"./ListItem-DNcJ_hTP.js";import{u as se}from"./useForkRef-CXnDbkaK.js";import{B as oe}from"./ButtonBase-CL1dL2Cz.js";import{L}from"./ListItemIcon-2ml_yMfP.js";import{L as v}from"./ListItemText-D4W6YSyB.js";import{I as l}from"./Icon-BwfjAmbM.js";import{L as re}from"./List-jYW9fhKK.js";import"./preload-helper-Dp1pzeXC.js";import"./isMuiElement-CuvvcMPv.js";import"./TransitionGroupContext-DkIGTr29.js";import"./listItemIconClasses-C9wThiCW.js";import"./listItemTextClasses-DsrlZgkx.js";import"./useSlot-DcL_IPHt.js";const ne=(e,s)=>{const{ownerState:o}=e;return[s.root,o.dense&&s.dense,o.alignItems==="flex-start"&&s.alignItemsFlexStart,o.divider&&s.divider,!o.disableGutters&&s.gutters]},ae=e=>{const{alignItems:s,classes:o,dense:d,disabled:n,disableGutters:m,divider:p,selected:h}=e,a=K({root:["root",d&&"dense",!m&&"gutters",p&&"divider",n&&"disabled",s==="flex-start"&&"alignItemsFlexStart",h&&"selected"]},ee,o);return{...o,...a}},ie=Q(oe,{shouldForwardProp:e=>X(e)||e==="classes",name:"MuiListItemButton",slot:"Root",overridesResolver:ne})(Y(({theme:e})=>({display:"flex",flexGrow:1,justifyContent:"flex-start",alignItems:"center",position:"relative",textDecoration:"none",minWidth:0,boxSizing:"border-box",textAlign:"left",paddingTop:8,paddingBottom:8,transition:e.transitions.create("background-color",{duration:e.transitions.duration.shortest}),"&:hover":{textDecoration:"none",backgroundColor:(e.vars||e).palette.action.hover,"@media (hover: none)":{backgroundColor:"transparent"}},[`&.${c.selected}`]:{backgroundColor:e.vars?`rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})`:x(e.palette.primary.main,e.palette.action.selectedOpacity),[`&.${c.focusVisible}`]:{backgroundColor:e.vars?`rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.focusOpacity}))`:x(e.palette.primary.main,e.palette.action.selectedOpacity+e.palette.action.focusOpacity)}},[`&.${c.selected}:hover`]:{backgroundColor:e.vars?`rgba(${e.vars.palette.primary.mainChannel} / calc(${e.vars.palette.action.selectedOpacity} + ${e.vars.palette.action.hoverOpacity}))`:x(e.palette.primary.main,e.palette.action.selectedOpacity+e.palette.action.hoverOpacity),"@media (hover: none)":{backgroundColor:e.vars?`rgba(${e.vars.palette.primary.mainChannel} / ${e.vars.palette.action.selectedOpacity})`:x(e.palette.primary.main,e.palette.action.selectedOpacity)}},[`&.${c.focusVisible}`]:{backgroundColor:(e.vars||e).palette.action.focus},[`&.${c.disabled}`]:{opacity:(e.vars||e).palette.action.disabledOpacity},variants:[{props:({ownerState:s})=>s.divider,style:{borderBottom:`1px solid ${(e.vars||e).palette.divider}`,backgroundClip:"padding-box"}},{props:{alignItems:"flex-start"},style:{alignItems:"flex-start"}},{props:({ownerState:s})=>!s.disableGutters,style:{paddingLeft:16,paddingRight:16}},{props:({ownerState:s})=>s.dense,style:{paddingTop:4,paddingBottom:4}}]}))),ce=u.forwardRef(function(s,o){const d=Z({props:s,name:"MuiListItemButton"}),{alignItems:n="center",autoFocus:m=!1,component:p="div",children:h,dense:j=!1,disableGutters:a=!1,divider:_=!1,focusVisibleClassName:U,selected:z=!1,className:H,...i}=d,S=u.useContext(P),k=u.useMemo(()=>({dense:j||S.dense||!1,alignItems:n,disableGutters:a}),[n,S.dense,j,a]),B=u.useRef(null);q(()=>{m&&B.current&&B.current.focus()},[m]);const $={...d,alignItems:n,dense:k.dense,disableGutters:a,divider:_,selected:z},C=ae($),J=se(B,o);return t.jsx(P.Provider,{value:k,children:t.jsx(ie,{ref:J,href:i.href||i.to,component:(i.href||i.to)&&p==="div"?"button":p,focusVisibleClassName:O(C.focusVisible,U),ownerState:$,className:O(C.root,H),...i,classes:C,children:h})})}),r=ce;r.displayName="Gui.ListItemButton";const Be={title:"Molecules/List/ListItemButton",component:r,tags:["autodocs"],decorators:[e=>t.jsx("div",{style:{padding:16,minHeight:260,maxWidth:560},children:t.jsx(e,{})})],parameters:{docs:{description:{component:`
...
}`,...(V=(F=f.parameters)==null?void 0:F.docs)==null?void 0:V.source}}};const Ce=["Playground","WithTrailingIcon","AsAnchorLink","WithSx"];export{y as AsAnchorLink,I as Playground,f as WithSx,g as WithTrailingIcon,Ce as __namedExportsOrder,Be as default};
