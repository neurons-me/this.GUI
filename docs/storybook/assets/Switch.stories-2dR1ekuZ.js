import{p as le,q as ne,r as v,h as ce,c as z,j as e,i as M,aV as Y,k as ie,s as G,n as H,a as P,B as de}from"./iframe-BzW5L-sB.js";import{S as o}from"./Switch-CiVIUQHI.js";import{S as c}from"./Stack-DvnhhsNE.js";import{f as pe}from"./formControlState-Dq1zat_P.js";import{u as me}from"./useSlot-CYJL6v7h.js";import{u as ue}from"./useFormControl-DWtZ3EhL.js";import"./preload-helper-Dp1pzeXC.js";import"./useControlled-5D3yaU0Z.js";import"./ButtonBase-DEfx69p-.js";import"./TransitionGroupContext-DBebgn_y.js";import"./useForkRef-BZw98wdx.js";import"./useEventCallback-0bk4YSZd.js";import"./getThemeProps-B6mr4j-q.js";function he(a){return le("MuiFormControlLabel",a)}const i=ne("MuiFormControlLabel",["root","labelPlacementStart","labelPlacementTop","labelPlacementBottom","disabled","label","error","required","asterisk"]),be=a=>{const{classes:t,disabled:s,labelPlacement:r,error:x,required:S}=a,k={root:["root",s&&"disabled",`labelPlacement${Y(r)}`,x&&"error",S&&"required"],label:["label",s&&"disabled"],asterisk:["asterisk",x&&"error"]};return ie(k,he,t)},ge=G("label",{name:"MuiFormControlLabel",slot:"Root",overridesResolver:(a,t)=>{const{ownerState:s}=a;return[{[`& .${i.label}`]:t.label},t.root,t[`labelPlacement${Y(s.labelPlacement)}`]]}})(H(({theme:a})=>({display:"inline-flex",alignItems:"center",cursor:"pointer",verticalAlign:"middle",WebkitTapHighlightColor:"transparent",marginLeft:-11,marginRight:16,[`&.${i.disabled}`]:{cursor:"default"},[`& .${i.label}`]:{[`&.${i.disabled}`]:{color:(a.vars||a).palette.text.disabled}},variants:[{props:{labelPlacement:"start"},style:{flexDirection:"row-reverse",marginRight:-11}},{props:{labelPlacement:"top"},style:{flexDirection:"column-reverse"}},{props:{labelPlacement:"bottom"},style:{flexDirection:"column"}},{props:({labelPlacement:t})=>t==="start"||t==="top"||t==="bottom",style:{marginLeft:16}}]}))),fe=G("span",{name:"MuiFormControlLabel",slot:"Asterisk",overridesResolver:(a,t)=>t.asterisk})(H(({theme:a})=>({[`&.${i.error}`]:{color:(a.vars||a).palette.error.main}}))),l=v.forwardRef(function(t,s){const r=ce({props:t,name:"MuiFormControlLabel"}),{checked:x,className:S,componentsProps:k={},control:d,disabled:J,disableTypography:K,inputRef:ye,label:Q,labelPlacement:X="end",name:Ce,onChange:xe,required:Z,slots:ee={},slotProps:ae={},value:Se,...te}=r,p=ue(),L=J??d.props.disabled??(p==null?void 0:p.disabled),w=Z??d.props.required,F={disabled:L,required:w};["checked","name","onChange","value","inputRef"].forEach(h=>{typeof d.props[h]>"u"&&typeof r[h]<"u"&&(F[h]=r[h])});const oe=pe({props:r,muiFormControl:p,states:["error"]}),m={...r,disabled:L,labelPlacement:X,required:w,error:oe.error},j=be(m),re={slots:ee,slotProps:{...k,...ae}},[se,u]=me("typography",{elementType:z,externalForwardedProps:re,ownerState:m});let n=Q;return n!=null&&n.type!==z&&!K&&(n=e.jsx(se,{component:"span",...u,className:M(j.label,u==null?void 0:u.className),children:n})),e.jsxs(ge,{className:M(j.root,S),ownerState:m,ref:s,...te,children:[v.cloneElement(d,F),w?e.jsxs("div",{children:[n,e.jsxs(fe,{ownerState:m,"aria-hidden":!0,className:j.asterisk,children:[" ","*"]})]}):n]})}),Re={title:"Atoms/Forms & Inputs/Switch",component:o,tags:["autodocs"],decorators:[a=>e.jsx(de,{sx:{p:2},children:e.jsx(a,{})})],parameters:{docs:{description:{component:`
...
}`,...(O=(D=y.parameters)==null?void 0:D.docs)==null?void 0:O.source}}};var $,V,_;C.parameters={...C.parameters,docs:{...($=C.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: 'Edge & custom sx',
  render: () => <Stack spacing={2}>
...
}`,...(_=(V=C.parameters)==null?void 0:V.docs)==null?void 0:_.source}}};const Ae=["Playground","LabeledVariants","SizesAndColors","ControlledExample","EdgeAndSx"];export{y as ControlledExample,C as EdgeAndSx,g as LabeledVariants,b as Playground,f as SizesAndColors,Ae as __namedExportsOrder,Re as default};
