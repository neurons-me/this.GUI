import{j as e,L as X,r as y,c as J,R as le,as as pe,d as ue,ap as B}from"./iframe-DTkfRnJf.js";import{I as R}from"./Icon-BM-Jwf27.js";import{M as ce}from"./Menu-D5Y3vMKV.js";import{M as O}from"./MenuItem-2cLCpEHr.js";import{Link as de}from"./index-SqSAGI1r.js";import{u as U}from"./useGuiMediaQuery-2dRYGcLF.js";import{u as me,a as he}from"./useInsets-DrPGyJYK.js";import{A as ye}from"./Avatar-uhnXAEOq.js";import{A as fe}from"./AppBar-BgpiADh6.js";import{T as ge}from"./Toolbar-D1lLG2L5.js";const _=({label:t,href:r,icon:n,iconColor:o,external:a,showLabel:i=!0})=>{const l=e.jsxs(e.Fragment,{children:[n&&e.jsx(R,{name:n,iconColor:o||"currentColor",style:{marginRight:3,fontSize:20,position:"relative",top:-1}}),i&&e.jsx("span",{children:t})]});return e.jsx(X,{href:r??"#",target:a?"_blank":"_self",style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none"},children:l})};_.__docgenInfo={description:"",methods:[],displayName:"TopBarLink",props:{label:{required:!0,tsType:{name:"string"},description:""},href:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"string"},description:""},external:{required:!1,tsType:{name:"boolean"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon. Defaults to true.",defaultValue:{value:"true",computed:!1}}}};const K=(t,r,n,o)=>t.map(({label:a,href:i,icon:l,iconColor:h,external:d,items:f},T)=>{const v=a??i??T,u=n.has(a),g=e.jsxs(X,{to:d?void 0:i,href:d?i:void 0,target:d?"_blank":void 0,style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none",flexGrow:1},children:[l&&e.jsx(R,{name:typeof l=="string"?l:"info",iconColor:h||"currentColor",style:{marginRight:2,fontSize:20,position:"relative",top:-1}}),a]});return f&&f.length>0?e.jsxs(le.Fragment,{children:[e.jsxs(O,{onClick:()=>o(a),sx:{color:"inherit",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[g,e.jsx(R,{name:u?"expand_less":"expand_more",iconColor:"currentColor",style:{fontSize:20,position:"relative",top:-1,marginLeft:1}})]}),e.jsx("div",{style:{maxHeight:u?"500px":"0px",opacity:u?1:0,overflow:"hidden",transition:"max-height 0.2s ease-out, opacity 0.2s ease-out",paddingLeft:16},children:K(f,r,n,o)})]},v):e.jsx(O,{onClick:r,sx:{color:"inherit"},children:g},v)}),S=({label:t,icon:r,iconColor:n,items:o,showLabel:a=!0})=>{const[i,l]=y.useState(null),[h,d]=y.useState(new Set),f=u=>{l(u.currentTarget)},T=()=>{l(null),d(new Set)},v=u=>{d(g=>{const k=new Set(g);return k.has(u)?k.delete(u):k.add(u),k})};return e.jsxs(e.Fragment,{children:[e.jsxs(J,{onClick:f,sx:{cursor:"pointer",px:1,display:"inline-flex",alignItems:"center",color:"inherit"},children:[r&&e.jsx(R,{name:typeof r=="string"?r:"info",iconColor:n||"currentColor",style:{marginRight:a?2:0,fontSize:20,position:"relative",top:-1}}),a&&e.jsx("span",{children:t})]}),e.jsx(ce,{anchorEl:i,open:!!i,onClose:T,sx:{color:"inherit"},children:o&&K(o,T,h,v)})]})};S.__docgenInfo={description:"",methods:[],displayName:"TopBarMenu",props:{label:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon in the top-level menu trigger. Defaults to true.",defaultValue:{value:"true",computed:!1}},items:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  href: string;
  icon?: ReactNode;
  iconColor?: string;
