...
~~~
        `}}},argTypes:{colorVariant:{control:{type:"select"},options:["default","subtle","strong"],description:"Predefined section variant based on theme.palette.section"},bgcolor:{control:"color",description:"Custom background color override"},padding:{control:{type:"number"},description:"Internal padding"},height:{control:{type:"text"},description:"Height (px, %, vh, etc.)"}},args:{colorVariant:"default",padding:4,height:"auto"}},l={render:n=>e.jsxs(i,{...n,children:[e.jsx(t,{variant:"h5",sx:{mb:1},children:"Playground Section"}),e.jsx(t,{variant:"body2",children:"Easily tweak padding, background, and height."})]})},g={render:n=>e.jsxs(s,{sx:{display:"flex",flexDirection:"column",gap:4},children:[e.jsxs(s,{children:[e.jsx(t,{variant:"h6",gutterBottom:!0,children:"Color Variants"}),e.jsx(s,{sx:{display:"grid",gap:2},children:["default","subtle","strong"].map(o=>e.jsxs(i,{...n,colorVariant:o,padding:3,children:[e.jsx(t,{variant:"subtitle1",children:o}),e.jsxs(t,{variant:"body2",children:["theme.palette.section.",o]})]},o))})]}),e.jsxs(s,{children:[e.jsx(t,{variant:"h6",gutterBottom:!0,children:"Custom Background"}),e.jsxs(i,{...n,bgcolor:"#2fb0a3ff",padding:4,children:[e.jsx(t,{variant:"subtitle1",children:"Custom bgcolor"}),e.jsx(t,{variant:"body2",children:"Manual background override"})]})]}),e.jsxs(s,{children:[e.jsx(t,{variant:"h6",gutterBottom:!0,children:"Responsive"}),e.jsxs(i,{...n,padding:{xs:2,sm:4,md:6},marginTop:{xs:1,sm:2,md:4},marginBottom:{xs:1,sm:3,md:5},children:[e.jsx(t,{variant:"subtitle1",children:"Responsive spacing"}),e.jsx(t,{variant:"body2",children:"Resize viewport to test"})]})]})]})};var R,B,k;l.parameters={...l.parameters,docs:{...(R=l.parameters)==null?void 0:R.docs,source:{originalSource:`{
...
}`,...(P=(V=g.parameters)==null?void 0:V.docs)==null?void 0:P.source}}};const K=["Playground","Variants"];export{l as Playground,g as Variants,K as __namedExportsOrder,J as default};
