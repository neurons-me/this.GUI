...
`]}),e.jsxs(n.p,{children:["That file demonstrates ",e.jsx(n.code,{children:".me + this.GUI"})," end-to-end with runtime tokens."]})]})]})}function S(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{S as default};
