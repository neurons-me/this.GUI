import{r as v,e as le,j as e,aA as Y}from"./iframe-BYWeTbVw.js";import{S as r}from"./Switch-CvMuxR-z.js";import{S as c}from"./Stack-CgW7xIk_.js";import{T as P}from"./Typography-BTe5Sves.js";import{c as z}from"./clsx-B-dksMZM.js";import{m as G}from"./memoTheme-BnPFCUjU.js";import{g as ne,a as ce}from"./generateUtilityClasses-DGi4yQgU.js";import{f as ie}from"./formControlState-Dq1zat_P.js";import{u as de}from"./useSlot-B-OlYqSH.js";import{u as me}from"./useFormControl-y1n73eIK.js";import{T as M}from"./Typography-DYoqaNaH.js";import{c as pe,s as H}from"./styled-BR6p0OHR.js";import{B as ue}from"./Box-D2VrL_Qb.js";import"./preload-helper-Dp1pzeXC.js";import"./Switch-BakkDJuf.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./useControlled-BwyH7ljD.js";import"./ButtonBase-tHL4M-xw.js";import"./TransitionGroupContext-DUPMztxk.js";import"./objectWithoutPropertiesLoose-Dsqj8S3w.js";import"./useForkRef-BLLRJTal.js";import"./useEventCallback-KgHUuHRa.js";import"./isFocusVisible-B8k4qzLc.js";import"./Stack-7M9wAlxs.js";import"./getThemeProps-BU2YxKoa.js";import"./Box-DrLvxTuL.js";function he(t){return ne("MuiFormControlLabel",t)}const i=ce("MuiFormControlLabel",["root","labelPlacementStart","labelPlacementTop","labelPlacementBottom","disabled","label","error","required","asterisk"]),be=t=>{const{classes:o,disabled:s,labelPlacement:a,error:x,required:S}=t,k={root:["root",s&&"disabled",`labelPlacement${Y(a)}`,x&&"error",S&&"required"],label:["label",s&&"disabled"],asterisk:["asterisk",x&&"error"]};return pe(k,he,o)},ge=H("label",{name:"MuiFormControlLabel",slot:"Root",overridesResolver:(t,o)=>{const{ownerState:s}=t;return[{[`& .${i.label}`]:o.label},o.root,o[`labelPlacement${Y(s.labelPlacement)}`]]}})(G(({theme:t})=>({display:"inline-flex",alignItems:"center",cursor:"pointer",verticalAlign:"middle",WebkitTapHighlightColor:"transparent",marginLeft:-11,marginRight:16,[`&.${i.disabled}`]:{cursor:"default"},[`& .${i.label}`]:{[`&.${i.disabled}`]:{color:(t.vars||t).palette.text.disabled}},variants:[{props:{labelPlacement:"start"},style:{flexDirection:"row-reverse",marginRight:-11}},{props:{labelPlacement:"top"},style:{flexDirection:"column-reverse"}},{props:{labelPlacement:"bottom"},style:{flexDirection:"column"}},{props:({labelPlacement:o})=>o==="start"||o==="top"||o==="bottom",style:{marginLeft:16}}]}))),fe=H("span",{name:"MuiFormControlLabel",slot:"Asterisk",overridesResolver:(t,o)=>o.asterisk})(G(({theme:t})=>({[`&.${i.error}`]:{color:(t.vars||t).palette.error.main}}))),l=v.forwardRef(function(o,s){const a=le({props:o,name:"MuiFormControlLabel"}),{checked:x,className:S,componentsProps:k={},control:d,disabled:J,disableTypography:K,inputRef:ye,label:Q,labelPlacement:X="end",name:Ce,onChange:xe,required:Z,slots:ee={},slotProps:te={},value:Se,...oe}=a,m=me(),L=J??d.props.disabled??(m==null?void 0:m.disabled),w=Z??d.props.required,F={disabled:L,required:w};["checked","name","onChange","value","inputRef"].forEach(h=>{typeof d.props[h]>"u"&&typeof a[h]<"u"&&(F[h]=a[h])});const re=ie({props:a,muiFormControl:m,states:["error"]}),p={...a,disabled:L,labelPlacement:X,required:w,error:re.error},j=be(p),ae={slots:ee,slotProps:{...k,...te}},[se,u]=de("typography",{elementType:M,externalForwardedProps:ae,ownerState:p});let n=Q;return n!=null&&n.type!==M&&!K&&(n=e.jsx(se,{component:"span",...u,className:z(j.label,u==null?void 0:u.className),children:n})),e.jsxs(ge,{className:z(j.root,S),ownerState:p,ref:s,...oe,children:[v.cloneElement(d,F),w?e.jsxs("div",{children:[n,e.jsxs(fe,{ownerState:p,"aria-hidden":!0,className:j.asterisk,children:[" ","*"]})]}):n]})}),He={title:"Atoms/Forms & Inputs/Switch",component:r,tags:["autodocs"],decorators:[t=>e.jsx(ue,{sx:{p:2},children:e.jsx(t,{})})],parameters:{docs:{description:{component:`
