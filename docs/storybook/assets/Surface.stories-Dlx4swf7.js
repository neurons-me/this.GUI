import{R as y,av as x,j as e,i as l,a as s,T as b}from"./iframe-AZWHUjJ8.js";import{P as S}from"./Paper-WNsmHt7k.js";import"./Toolbar-BSvLwMcQ.js";import"./ListItemIcon-D0PToHmB.js";import"./ListItemText-BXA55UDd.js";import"./Drawer-e1dj-DAL.js";import{S as k}from"./Stack-vReHNowo.js";import"./Tooltip-BoFE-j7F.js";import"./preload-helper-Dp1pzeXC.js";import"./Toolbar-CufKEqsg.js";import"./listItemIconClasses-Bkwn0ot7.js";import"./ListContext-DVr4rWCd.js";import"./listItemTextClasses-CDjfeEGl.js";import"./useSlot-BWVERl7C.js";import"./useForkRef-BwxLbw6V.js";import"./Grow-0zMj_HpA.js";import"./TransitionGroupContext-L3XM6ARG.js";import"./Modal-Dfp-k0CT.js";import"./getThemeProps-DicCSZg3.js";import"./useControlled-mDa5gGP0.js";const r=y.forwardRef((t,m)=>{const{variant:o="default",color:T,elevation:h,sx:n,...v}=t,a=x(),p=o==="default"||o==="elevation"?"solid":o==="outlined"?"outline":o,f=p==="outline"?"outlined":"elevation",g=()=>{switch(p){case"outline":return{border:`1px solid ${a.palette.divider}`};case"glass":return{backgroundColor:l(a.palette.background.paper,.6),backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:`1px solid ${l(a.palette.divider,.6)}`,boxShadow:"none","@supports not (backdrop-filter: blur(12px))":{backgroundColor:l(a.palette.background.paper,.9)}};case"card":return{backgroundColor:a.palette.background.paper,borderRadius:a.shape.borderRadius,boxShadow:a.shadows[2]};case"solid":return{backgroundColor:a.palette.background.paper};default:return{}}};return e.jsx(S,{ref:m,variant:f,elevation:h,sx:[g(),...Array.isArray(n)?n:n?[n]:[]],...v})});r.displayName="Surface";r.__docgenInfo={description:`Surface
-------
...
| 'outlined'
| 'glass'
| 'card'`,elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'elevation'"},{name:"literal",value:"'solid'"},{name:"literal",value:"'outline'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'glass'"},{name:"literal",value:"'card'"}]},description:"Visual style for the surface.\n`default`/`elevation` map to the standard solid paper surface."},color:{required:!1,tsType:{name:"unknown"},description:""}},composes:["Omit"]};const M={title:"Atoms/Surface",component:r,tags:["autodocs"],parameters:{layout:"centered",decorators:[t=>e.jsx(b,{children:e.jsx(t,{})})],docs:{description:{component:`
...
~~~
`}}},argTypes:{variant:{control:{type:"select"},options:["default","glass","outline"],description:"The semantic style variant of the surface."},elevation:{control:{type:"range",min:0,max:24,step:1}},square:{control:{type:"boolean"}},color:{table:{disable:!0}}}},i={render:t=>e.jsxs(k,{spacing:4,sx:{padding:4,width:"50vw",minWidth:400,alignItems:"stretch"},children:[e.jsx(r,{variant:"default",elevation:2,sx:{p:2},children:e.jsx(s,{children:"Default Surface (elevation=2)"})}),e.jsx(r,{variant:"outline",elevation:3,sx:{p:2},children:e.jsx(s,{children:"Outline Variant (elevation=3)"})}),e.jsx(r,{variant:"glass",elevation:5,sx:{p:2,backgroundImage:"url(https://source.unsplash.com/random/400x200)",backgroundSize:"cover",backgroundPosition:"center"},children:e.jsx(s,{children:"Glass Variant (elevation=5)"})}),e.jsx(r,{variant:"default",elevation:8,sx:{p:2},children:e.jsx(s,{children:"Solid Variant (elevation=8)"})})]}),args:{}};var c,d,u;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
...
}`,...(u=(d=i.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const U=["Variants"];export{i as Variants,U as __namedExportsOrder,M as default};
