import{j as e,r as i,T as N,B as l,a as s,b as D,M as O}from"./iframe-VByCAMq0.js";import{R as $}from"./Router-gKgcIP4l.js";import{B as j}from"./Button-1wg7geSe.js";import{P as h}from"./Paper-D0g5YBdA.js";import{P as m}from"./InspectorToggle-l5ZL5CIN.js";import"./ListItemIcon-CZbD3kdS.js";import"./ListItemText-EGN6nTJf.js";import"./Drawer-Ce_ZhLjS.js";import{S as B}from"./Stack-C43D2WQo.js";import"./Tooltip-rRxgskYp.js";import{u as K}from"./useDeferredPending-cMxZhbi8.js";import"./preload-helper-Dp1pzeXC.js";import"./index-GfE-hmSP.js";import"./renderer-_xArEdk5.js";import"./parts-DDvDr5V5.js";import"./selectionStore-Coy7dh9o.js";import"./runtimeContext-CwXPNeJX.js";import"./Icon-BTDP3cyE.js";import"./Button-BDqwkNQI.js";import"./ButtonBase-Ddf4rdCO.js";import"./TransitionGroupContext-BsXbcIrf.js";import"./useForkRef-at6iFRE0.js";import"./CircularProgress-BiH9goPR.js";import"./Paper-CGsCy_dS.js";import"./Toolbar-B5C1gson.js";import"./IconButton-BiNRO4tv.js";import"./IconButton-CGlHk7MM.js";import"./listItemIconClasses-BIfuaFhY.js";import"./ListContext-CUbLHnka.js";import"./listItemTextClasses-0eqNW5zI.js";import"./useSlot-BQxwWLoj.js";import"./Grow-yTTW3IAg.js";import"./Modal-WpCfVUEs.js";import"./getThemeProps-BP5H2oeD.js";import"./useControlled-85p8TW_V.js";function W(n,r){return new Promise((f,t)=>{const y=window.setTimeout(()=>{p(),f()},n),o=()=>{window.clearTimeout(y),p(),t(new DOMException("Aborted","AbortError"))},p=()=>{r==null||r.removeEventListener("abort",o)};if(r!=null&&r.aborted){o();return}r==null||r.addEventListener("abort",o,{once:!0})})}function k(){return e.jsxs(m,{padding:3,children:[e.jsx(s,{variant:"h4",children:"Dashboard"}),e.jsx(s,{variant:"body2",sx:{opacity:.78,mt:.5},children:"Stable home screen used as the fallback context."}),e.jsxs(h,{sx:{p:2,borderRadius:2,mt:2},children:[e.jsx(s,{variant:"body1",children:"Everything is healthy"}),e.jsx(s,{variant:"body2",sx:{opacity:.8},children:"Use this screen to test failed route transitions."})]})]})}function A(){return e.jsxs(m,{padding:3,children:[e.jsx(s,{variant:"h4",children:"Reports"}),e.jsx(s,{variant:"body2",sx:{opacity:.78,mt:.5},children:"The route resolved successfully."}),e.jsxs(h,{sx:{p:2,borderRadius:2,mt:2},children:[e.jsx(s,{variant:"body1",children:"Loaded latest report data"}),e.jsx(s,{variant:"body2",sx:{opacity:.8},children:"This is the successful version of the async route."})]})]})}function X(n){return e.jsxs(m,{padding:3,children:[e.jsx(s,{variant:"h4",children:"Loading route..."}),e.jsx(s,{variant:"body2",sx:{opacity:.78,mt:.5},children:`Preparing ${n}`}),e.jsxs(h,{sx:{p:2,borderRadius:2,mt:2,borderStyle:"dashed",borderWidth:1,borderColor:"divider"},children:[e.jsx(s,{variant:"body1",children:"Pending shell"}),e.jsx(s,{variant:"body2",sx:{opacity:.8},children:"The route transition is still in flight."})]})]})}function I(n,r){return e.jsxs(h,{sx:{p:2,borderRadius:2,mt:2,border:"1px solid",borderColor:"error.main"},children:[e.jsx(s,{variant:"body1",sx:{color:"error.main",fontWeight:700},children:"Route failed"}),e.jsx(s,{variant:"body2",sx:{opacity:.82,mt:.5},children:n}),r&&e.jsx(j,{sx:{mt:2},variant:"outlined",color:"error",onClick:r,children:"Retry"})]})}function P(n,r){return e.jsxs(m,{padding:3,children:[e.jsx(s,{variant:"h4",children:"Route failed"}),e.jsx(s,{variant:"body2",sx:{opacity:.78,mt:.5},children:"The next route could not be resolved."}),I(n,r)]})}function v({mode:n,title:r,subtitle:f}){const t=i.useMemo(()=>new $({useHistory:!1,notFound:(a,d)=>P(d instanceof Error?d.message:"Unknown route failure")}),[]),[y,o]=i.useState(()=>k()),[p,U]=i.useState("/dashboard"),[g,w]=i.useState(null),[b,R]=i.useState(null),{isRunning:_,showLoader:x,run:T,cancel:E}=K({threshold:180,onCancelPrevious:"abort"});i.useEffect(()=>{t.set("/dashboard",()=>k()),t.set("/reports",()=>A());const a=t.onChange((d,c)=>{o(d),U(c.path)});return t.navigate("/dashboard",{push:!1}),()=>{a(),E(),t.destroy()}},[E,t]),i.useEffect(()=>{n==="swap"&&x&&b&&o(X(b))},[n,b,x]);const u=i.useCallback(async(a,d)=>{R(a),w(null);try{await T(async({signal:c})=>{if(await W(240,c),d)throw new Error("The reports service is temporarily unavailable.");return t.navigate(a,{push:!1})})}catch(c){const S=c instanceof Error?c.message:"Unknown route failure";w(S),n==="swap"&&o(P(S,()=>void u(a,!1)))}finally{R(null)}},[n,t,T]),H=x&&n!=="swap";return e.jsx(N,{initialThemeId:"neurons.me",initialMode:"dark",children:e.jsxs(l,{sx:{p:3,display:"grid",gap:2},children:[e.jsxs(l,{children:[e.jsx(s,{sx:{fontSize:20,fontWeight:800},children:r}),e.jsx(s,{sx:{opacity:.8,mt:.5},children:f})]}),e.jsxs(B,{direction:{xs:"column",md:"row"},spacing:1.5,children:[e.jsx(j,{variant:"contained",onClick:()=>void u("/dashboard",!1),children:"Dashboard"}),e.jsx(j,{variant:"outlined",color:"success",onClick:()=>void u("/reports",!1),children:"Success Route"}),e.jsx(j,{variant:"outlined",color:"error",onClick:()=>void u("/reports",!0),children:"Fail Route"})]}),e.jsxs(h,{sx:{p:2},children:[e.jsxs(s,{variant:"body2",sx:{opacity:.78},children:["Current path: ",e.jsx(l,{component:"span",sx:{fontFamily:"monospace"},children:p})]}),e.jsx(s,{variant:"body2",sx:{opacity:.78,mt:.75},children:n==="keep"?"Recipe: preserve the previous screen and attach an error panel if the next route fails.":n==="swap"?"Recipe: move into a pending shell and then swap into an error shell if resolution fails.":"Recipe: show an inline error with a retry button that retries the same route."}),e.jsxs(s,{variant:"body2",sx:{opacity:.68,mt:.75},children:["Transition state: ",_?x?"showing loader":"waiting below threshold":"idle"]})]}),e.jsxs(l,{sx:{position:"relative",minHeight:320,borderRadius:2,overflow:"hidden",border:"1px solid",borderColor:"divider",backgroundColor:"background.default"},children:[e.jsxs(l,{sx:{minHeight:320},children:[y,g&&n!=="swap"&&I(g,n==="retry"?()=>void u("/reports",!1):void 0)]}),H&&e.jsx(l,{sx:{position:"absolute",inset:0,display:"grid",placeItems:"center",bgcolor:"rgba(12,14,18,0.32)",backdropFilter:"blur(6px)"},children:e.jsxs(h,{sx:{px:2,py:1.5,borderRadius:2},children:[e.jsx(s,{sx:{fontWeight:700},children:"Resolving route..."}),e.jsx(s,{variant:"body2",sx:{opacity:.78},children:"The transition is still in flight."})]})})]})]})})}function F(){return e.jsx(v,{mode:"keep",title:"Recipe 1: Keep Previous Screen On Error",subtitle:"When the next route fails, preserve the current screen and surface the failure locally."})}function L(){return e.jsx(v,{mode:"swap",title:"Recipe 2: Swap To Error Shell",subtitle:"Use this when the route itself owns the error state and deserves a full-screen failure shell."})}function M(){return e.jsx(v,{mode:"retry",title:"Recipe 3: Retry Failed Route",subtitle:"Inline retry works well when the user should stay anchored to the current screen."})}F.__docgenInfo={description:"",methods:[],displayName:"KeepPreviousScreenOnErrorDemo"};L.__docgenInfo={description:"",methods:[],displayName:"SwapToErrorShellDemo"};M.__docgenInfo={description:"",methods:[],displayName:"RetryFailedRouteDemo"};function C(n){const r={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...D(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(O,{title:"Router/Error Handling"}),`
...
`]})]})}function ke(n={}){const{wrapper:r}={...D(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(C,{...n})}):C(n)}export{ke as default};
