import{au as c,u as v,j as m,g as t}from"./iframe-VByCAMq0.js";import{P as f}from"./Paper-CGsCy_dS.js";const n=c.forwardRef((l,i)=>{const{variant:a="default",color:b,elevation:s,sx:r,...u}=l,e=v(),o=a==="default"||a==="elevation"?"solid":a==="outlined"?"outline":a,d=o==="outline"?"outlined":"elevation",p=()=>{switch(o){case"outline":return{border:`1px solid ${e.palette.divider}`};case"glass":return{backgroundColor:t(e.palette.background.paper,.6),backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:`1px solid ${t(e.palette.divider,.6)}`,boxShadow:"none","@supports not (backdrop-filter: blur(12px))":{backgroundColor:t(e.palette.background.paper,.9)}};case"card":return{backgroundColor:e.palette.background.paper,borderRadius:e.shape.borderRadius,boxShadow:e.shadows[2]};case"solid":return{backgroundColor:e.palette.background.paper};default:return{}}};return m.jsx(f,{ref:i,variant:d,elevation:s,sx:[p(),...Array.isArray(r)?r:r?[r]:[]],...u})});n.displayName="Surface";n.__docgenInfo={description:`Surface
-------
