import{aB as y,av as b,j as e,h as l,a as s,T as x}from"./iframe-C2qc3tsM.js";import{P as S}from"./Paper-WjnWTzrc.js";import{S as k}from"./Stack-CJpHzZFp.js";import"./preload-helper-Dp1pzeXC.js";import"./getThemeProps-DGpb-X_S.js";const r=y.forwardRef((t,h)=>{const{variant:o="solid",color:T,elevation:v,sx:n,...f}=t,a=b(),c=o==="default"||o==="elevation"?"solid":o==="outlined"?"outline":o,g=c==="outline"?"outlined":"elevation",m=()=>{switch(c){case"outline":return{border:`1px solid ${a.palette.divider}`};case"glass":return{backgroundColor:l(a.palette.background.paper,.6),backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:`1px solid ${l(a.palette.divider,.6)}`,boxShadow:"none","@supports not (backdrop-filter: blur(12px))":{backgroundColor:l(a.palette.background.paper,.9)}};case"card":return{backgroundColor:a.palette.background.paper,borderRadius:a.shape.borderRadius,boxShadow:a.shadows[2]};case"solid":return{backgroundColor:a.palette.background.paper};default:return{}}};return e.jsx(S,{ref:h,variant:g,elevation:v,sx:[m(),...Array.isArray(n)?n:n?[n]:[]],...f})});r.displayName="Surface";r.__docgenInfo={description:`Surface
-------
...
'card': A pre-styled surface for card-like containers.`},color:{required:!1,tsType:{name:"any"},description:""}}};const V={title:"Atoms/Surface",component:r,tags:["autodocs"],parameters:{layout:"centered",decorators:[t=>e.jsx(x,{children:e.jsx(t,{})})],docs:{description:{component:`
...
~~~
`}}},argTypes:{variant:{control:{type:"select"},options:["default","glass","outline"],description:"The semantic style variant of the surface."},elevation:{control:{type:"range",min:0,max:24,step:1}},square:{control:{type:"boolean"}},color:{table:{disable:!0}}}},i={render:t=>e.jsxs(k,{spacing:4,sx:{padding:4,width:"50vw",minWidth:400,alignItems:"stretch"},children:[e.jsx(r,{variant:"default",elevation:2,sx:{p:2},children:e.jsx(s,{children:"Default Surface (elevation=2)"})}),e.jsx(r,{variant:"outline",elevation:3,sx:{p:2},children:e.jsx(s,{children:"Outline Variant (elevation=3)"})}),e.jsx(r,{variant:"glass",elevation:5,sx:{p:2,backgroundImage:"url(https://source.unsplash.com/random/400x200)",backgroundSize:"cover",backgroundPosition:"center"},children:e.jsx(s,{children:"Glass Variant (elevation=5)"})}),e.jsx(r,{variant:"default",elevation:8,sx:{p:2},children:e.jsx(s,{children:"Solid Variant (elevation=8)"})})]}),args:{}};var d,p,u;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(u=(p=i.parameters)==null?void 0:p.docs)==null?void 0:u.source}}};const q=["Variants"];export{i as Variants,q as __namedExportsOrder,V as default};
