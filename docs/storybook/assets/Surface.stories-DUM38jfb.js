import{aA as y,au as x,j as e,g as l,a as s,T as b}from"./iframe-DzQ8qlS5.js";import"./Button-C4I8Jen7.js";import{S}from"./Stack-BWXDYBao.js";import{P as k}from"./Paper-CEEYXBBa.js";import"./preload-helper-Dp1pzeXC.js";import"./Icon-4frSiLka.js";import"./Button-BFu9Bpz3.js";import"./ButtonBase-B1YySNdu.js";import"./TransitionGroupContext-dQxgozz0.js";import"./useForkRef-DYkjEL9P.js";import"./CircularProgress-uyQXuKQe.js";import"./getThemeProps-DZDwyubZ.js";const r=y.forwardRef((t,m)=>{const{variant:o="default",color:T,elevation:h,sx:n,...v}=t,a=x(),p=o==="default"||o==="elevation"?"solid":o==="outlined"?"outline":o,f=p==="outline"?"outlined":"elevation",g=()=>{switch(p){case"outline":return{border:`1px solid ${a.palette.divider}`};case"glass":return{backgroundColor:l(a.palette.background.paper,.6),backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:`1px solid ${l(a.palette.divider,.6)}`,boxShadow:"none","@supports not (backdrop-filter: blur(12px))":{backgroundColor:l(a.palette.background.paper,.9)}};case"card":return{backgroundColor:a.palette.background.paper,borderRadius:a.shape.borderRadius,boxShadow:a.shadows[2]};case"solid":return{backgroundColor:a.palette.background.paper};default:return{}}};return e.jsx(k,{ref:m,variant:f,elevation:h,sx:[g(),...Array.isArray(n)?n:n?[n]:[]],...v})});r.displayName="Surface";r.__docgenInfo={description:`Surface
-------
...
| 'outlined'
| 'glass'
| 'card'`,elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'elevation'"},{name:"literal",value:"'solid'"},{name:"literal",value:"'outline'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'glass'"},{name:"literal",value:"'card'"}]},description:"Visual style for the surface.\n`default`/`elevation` map to the standard solid paper surface."},color:{required:!1,tsType:{name:"unknown"},description:""}},composes:["Omit"]};const N={title:"Atoms/Surface",component:r,tags:["autodocs"],parameters:{layout:"centered",decorators:[t=>e.jsx(b,{children:e.jsx(t,{})})],docs:{description:{component:`
...
~~~
`}}},argTypes:{variant:{control:{type:"select"},options:["default","glass","outline"],description:"The semantic style variant of the surface."},elevation:{control:{type:"range",min:0,max:24,step:1}},square:{control:{type:"boolean"}},color:{table:{disable:!0}}}},i={render:t=>e.jsxs(S,{spacing:4,sx:{padding:4,width:"50vw",minWidth:400,alignItems:"stretch"},children:[e.jsx(r,{variant:"default",elevation:2,sx:{p:2},children:e.jsx(s,{children:"Default Surface (elevation=2)"})}),e.jsx(r,{variant:"outline",elevation:3,sx:{p:2},children:e.jsx(s,{children:"Outline Variant (elevation=3)"})}),e.jsx(r,{variant:"glass",elevation:5,sx:{p:2,backgroundImage:"url(https://source.unsplash.com/random/400x200)",backgroundSize:"cover",backgroundPosition:"center"},children:e.jsx(s,{children:"Glass Variant (elevation=5)"})}),e.jsx(r,{variant:"default",elevation:8,sx:{p:2},children:e.jsx(s,{children:"Solid Variant (elevation=8)"})})]}),args:{}};var c,d,u;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
...
}`,...(u=(d=i.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const _=["Variants"];export{i as Variants,_ as __namedExportsOrder,N as default};
