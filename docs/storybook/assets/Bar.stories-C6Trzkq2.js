import{j as r,a as s,B as V}from"./iframe-D9h36_NB.js";import{A as t,T as i}from"./Toolbar-CFR7H8jC.js";import{B as e}from"./Button-BYqM0JcA.js";import"./preload-helper-Dp1pzeXC.js";import"./Toolbar-DgEuSs1E.js";import"./Paper-BbGiJwVi.js";import"./Icon-0UwWLaxE.js";import"./Button-j-Mhs7fk.js";import"./ButtonBase-DIt9aqy4.js";import"./TransitionGroupContext-speb4CnD.js";import"./useForkRef-DJcJK6M1.js";import"./useEventCallback-DWW8G7u7.js";import"./CircularProgress-DYuf6jvR.js";const or={title:"Atoms/Containers/Bar",component:t,tags:["autodocs"],decorators:[a=>r.jsx("div",{style:{padding:0,minHeight:240},children:r.jsx(a,{})})],parameters:{docs:{description:{component:`
...
> The resolver maps this spec to real React elements, preserving polymorphism and \`sx\` styling.
        `}}},argTypes:{variant:{control:{type:"select"},options:["mui","glass"],description:"Semantic preset. mui (default): behaves like MUI Bar. glass: floating blurred panel style."},position:{control:{type:"select"},options:["fixed","absolute","sticky","static","relative"]},color:{control:{type:"select"},options:["default","inherit","primary","secondary","transparent"]},elevation:{control:{type:"number"}},enableColorOnDark:{control:{type:"boolean"}},component:{table:{disable:!0}}},args:{variant:void 0,position:"fixed",elevation:0,enableColorOnDark:!1,sx:{borderBottom:"1px solid",borderColor:"divider"}}},l={render:a=>r.jsx(t,{...a,children:r.jsxs(i,{variant:"dense",children:[r.jsx(s,{variant:"h6",sx:{flexGrow:1},children:"Playground"}),r.jsx(e,{variant:"text",children:"Action"})]})})},p={render:a=>r.jsx("div",{style:{display:"grid",gap:16},children:["fixed","absolute","sticky","static","relative"].map(o=>r.jsx(t,{...a,position:o,children:r.jsxs(i,{variant:"dense",children:[r.jsxs(s,{variant:"subtitle1",sx:{flexGrow:1},children:["position = ",o]}),r.jsx(e,{variant:"text",children:"Action"})]})},o))})},c={parameters:{docs:{description:{story:"\nThe Bar component only supports the following values for the `color` prop: `default`, `inherit`, `primary`, `secondary`, and `transparent`.\nFor colors like `success`, `info`, `warning`, and `error`, use the `sx` prop with `bgcolor` instead, e.g. `sx={{ bgcolor: 'success.main' }}`.\n        "}}},args:{position:"static"},render:a=>r.jsx("div",{style:{display:"grid",gap:12},children:["default","inherit","primary","secondary","transparent"].map(o=>r.jsx(t,{...a,color:o,children:r.jsxs(i,{variant:"dense",children:[r.jsxs(s,{variant:"subtitle2",sx:{flexGrow:1},children:["color = ",o]}),r.jsx(e,{variant:"text",children:"Action"})]})},o))})},n={args:{position:"static"},render:a=>r.jsx("div",{style:{display:"grid",gap:12},children:["success.main","info.main","warning.main","error.main"].map(o=>r.jsx(t,{...a,sx:{bgcolor:o},children:r.jsxs(i,{variant:"dense",children:[r.jsx(s,{variant:"subtitle2",sx:{flexGrow:1},children:`sx.bgcolor = ${o}`}),r.jsx(e,{variant:"text",children:"Action"})]})},o))})},d={args:{position:"static",color:"default"},render:a=>r.jsx(t,{...a,sx:{px:2,borderBottom:"1px solid",borderColor:"divider"},children:r.jsxs(i,{variant:"dense",children:[r.jsx(s,{variant:"h6",sx:{flexGrow:1},children:"With Toolbar"}),r.jsxs(V,{sx:{display:"flex",gap:1},children:[r.jsx(e,{variant:"text",children:"Login"}),r.jsx(e,{variant:"contained",color:"primary",children:"Sign up"})]})]})})},x={args:{position:"static",color:"default"},render:a=>r.jsx("div",{style:{display:"grid",gap:12},children:[0,1,2,4,8].map(o=>r.jsx(t,{...a,elevation:o,children:r.jsxs(i,{variant:"dense",children:[r.jsxs(s,{variant:"subtitle2",sx:{flexGrow:1},children:["elevation = ",o]}),r.jsx(e,{variant:"text",children:"Action"})]})},o))})},u={args:{position:"static",color:"primary",enableColorOnDark:!0},render:a=>r.jsx(t,{...a,children:r.jsxs(i,{variant:"dense",children:[r.jsx(s,{variant:"subtitle2",sx:{flexGrow:1},children:"enableColorOnDark = true"}),r.jsx(e,{variant:"text",children:"Action"})]})})},g={args:{position:"static",color:"default",variant:void 0},render:a=>r.jsx("div",{style:{display:"grid",gap:12},children:["mui","glass"].map(o=>r.jsx(t,{...a,variant:o,children:r.jsxs(i,{variant:"dense",children:[r.jsxs(s,{variant:"subtitle2",sx:{flexGrow:1},children:["variant = ",o]}),r.jsx(e,{variant:"text",children:"Action"})]})},o))})};var y,h,m;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
...
}`,...(m=(h=l.parameters)==null?void 0:h.docs)==null?void 0:m.source}}};var v,b,f;p.parameters={...p.parameters,docs:{...(v=p.parameters)==null?void 0:v.docs,source:{originalSource:`{
...
}`,...(M=(W=u.parameters)==null?void 0:W.docs)==null?void 0:M.source}}};var F,L,R;g.parameters={...g.parameters,docs:{...(F=g.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    position: 'static',
    color: 'default',
    variant: undefined
...
}`,...(R=(L=g.parameters)==null?void 0:L.docs)==null?void 0:R.source}}};const ar=["Playground","Positions","Colors","CustomColorsWithSx","WithToolbar","Elevation","EnableColorOnDark","Variants"];export{c as Colors,n as CustomColorsWithSx,x as Elevation,u as EnableColorOnDark,l as Playground,p as Positions,g as Variants,d as WithToolbar,ar as __namedExportsOrder,or as default};
