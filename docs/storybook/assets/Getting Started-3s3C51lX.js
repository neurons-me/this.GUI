import{j as e,B as s,a as i,u as l,M as c,T as o}from"./iframe-ByX3ETbE.js";import{G as a}from"./GettingStartedHero-DV06K7aC.js";import{S as h}from"./Stack-BOeTzEL3.js";import{B as x}from"./Button-UIsVxBSN.js";import{Q as p}from"./RouterSemanticsDemos-CvJQdzh3.js";import"./preload-helper-Dp1pzeXC.js";import"./Icon-n_Q28tJ5.js";import"./getThemeProps-CPqAk1eQ.js";import"./Button-3QyS7usF.js";import"./ButtonBase-DEWtkUEw.js";import"./TransitionGroupContext-Dq0pQY8t.js";import"./useForkRef-B3XxOOe_.js";import"./useEventCallback-B-LLEq4r.js";import"./CircularProgress-B1xp4XjP.js";import"./Paper-DuBsD3ZW.js";import"./Paper-Bdr9tTxc.js";function d(){return e.jsxs(s,{sx:{mt:2,p:2,border:"1px solid",borderColor:"divider",borderRadius:2,backgroundColor:"background.paper"},children:[e.jsx(i,{variant:"subtitle2",sx:{mb:1,opacity:.78},children:"Rendered output"}),e.jsx(s,{sx:{p:2,borderRadius:2,backgroundColor:"background.default",color:"text.primary"},children:e.jsxs(h,{spacing:1.5,alignItems:"flex-start",children:[e.jsxs(s,{children:[e.jsx(i,{variant:"h4",sx:{fontWeight:700,mb:.5,color:"text.primary"},children:"Hello GUI"}),e.jsx(i,{variant:"body1",sx:{color:"text.primary"},children:"Your first rendered screen"})]}),e.jsx(x,{variant:"contained",children:"Click me"})]})})]})}d.__docgenInfo={description:"",methods:[],displayName:"FirstGuiPreview"};function t(r){const n={br:"br",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Getting Started/Quick Start"}),`
`,e.jsx(o,{children:e.jsxs(s,{component:"section",sx:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"44vh",py:4,textAlign:"center"},children:[e.jsx(a,{}),e.jsx(s,{sx:{width:"min(100%, 720px)",mt:4,borderBottom:"1px solid",borderColor:"divider",opacity:.45}})]})}),`
...
`]}),e.jsx(d,{}),e.jsx(n.hr,{}),e.jsx(n.h2,{id:"compose-with-children",children:"Compose With Children"}),e.jsx(n.p,{children:"Everything is just nested nodes."}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{
  "type": "Paper",
...
`]}),e.jsxs(n.p,{children:["That file demonstrates ",e.jsx(n.code,{children:".me + this.GUI"})," end-to-end with runtime tokens."]})]})]})}function R(r={}){const{wrapper:n}={...l(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{R as default};
