...
| 'outlined'
| 'glass'
| 'card'`,elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'elevation'"},{name:"literal",value:"'solid'"},{name:"literal",value:"'outline'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'glass'"},{name:"literal",value:"'card'"}]},description:"Visual style for the surface.\n`default`/`elevation` map to the standard solid paper surface."},color:{required:!1,tsType:{name:"unknown"},description:""}},composes:["Omit"]};const q={title:"Atoms/Surface",component:r,tags:["autodocs"],parameters:{layout:"centered",decorators:[t=>e.jsx(b,{children:e.jsx(t,{})})],docs:{description:{component:`
...
~~~
`}}},argTypes:{variant:{control:{type:"select"},options:["default","glass","outline"],description:"The semantic style variant of the surface."},elevation:{control:{type:"range",min:0,max:24,step:1}},square:{control:{type:"boolean"}},color:{table:{disable:!0}}}},i={render:t=>e.jsxs(S,{spacing:4,sx:{padding:4,width:"50vw",minWidth:400,alignItems:"stretch"},children:[e.jsx(r,{variant:"default",elevation:2,sx:{p:2},children:e.jsx(s,{children:"Default Surface (elevation=2)"})}),e.jsx(r,{variant:"outline",elevation:3,sx:{p:2},children:e.jsx(s,{children:"Outline Variant (elevation=3)"})}),e.jsx(r,{variant:"glass",elevation:5,sx:{p:2,backgroundImage:"url(https://source.unsplash.com/random/400x200)",backgroundSize:"cover",backgroundPosition:"center"},children:e.jsx(s,{children:"Glass Variant (elevation=5)"})}),e.jsx(r,{variant:"default",elevation:8,sx:{p:2},children:e.jsx(s,{children:"Solid Variant (elevation=8)"})})]}),args:{}};var p,d,u;i.parameters={...i.parameters,docs:{...(p=i.parameters)==null?void 0:p.docs,source:{originalSource:`{
...
}`,...(u=(d=i.parameters)==null?void 0:d.docs)==null?void 0:u.source}}};const C=["Variants"];export{i as Variants,C as __namedExportsOrder,q as default};
