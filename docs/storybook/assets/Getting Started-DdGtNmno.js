import{j as e,B as r,a as i,u as l,M as d,T as a}from"./iframe-BNfi7WN_.js";import{S as h}from"./Stack-B3Z6eKBo.js";import{B as x}from"./Button-COfTcQBR.js";import{Q as p}from"./RouterSemanticsDemos-rwo4bvwo.js";import"./preload-helper-Dp1pzeXC.js";import"./getThemeProps-DnzCZXIN.js";import"./Icon-NdOwP1f0.js";import"./createSvgIcon-BHDq88zH.js";import"./Button-b6VttKws.js";import"./ButtonBase-DUhu_tYS.js";import"./TransitionGroupContext-C503Ao5U.js";import"./useForkRef-BCDK4QT4.js";import"./useEventCallback-BjQzoJu9.js";import"./CircularProgress-DqeUalxs.js";import"./Paper-B_n6Pkkw.js";import"./Paper-DYZUo4tu.js";function o(){return e.jsx(e.Fragment,{children:e.jsxs(r,{sx:{color:"text.primary"},children:[e.jsx("img",{src:"GUI.png",alt:"This.GUI",style:{width:"320px",height:"auto",imageRendering:"auto",marginBottom:"14px"}}),e.jsx(i,{variant:"h1",sx:{fontWeight:700,letterSpacing:"-0.04em",mb:1,color:"text.primary"},children:".GUI"}),e.jsx(i,{variant:"h5",sx:{fontWeight:500,opacity:1,mb:2,color:"text.primary"},children:"Generative User Interfaces."})]})})}o.__docgenInfo={description:"",methods:[],displayName:"GUIHero"};function c(){return e.jsxs(r,{sx:{mt:2,p:2,border:"1px solid",borderColor:"divider",borderRadius:2,backgroundColor:"background.paper"},children:[e.jsx(i,{variant:"subtitle2",sx:{mb:1,opacity:.78},children:"Rendered output"}),e.jsx(r,{sx:{p:2,borderRadius:2,backgroundColor:"background.default",color:"text.primary"},children:e.jsxs(h,{spacing:1.5,alignItems:"flex-start",children:[e.jsxs(r,{children:[e.jsx(i,{variant:"h4",sx:{fontWeight:700,mb:.5,color:"text.primary"},children:"Hello GUI"}),e.jsx(i,{variant:"body1",sx:{color:"text.primary"},children:"Your first rendered screen"})]}),e.jsx(x,{variant:"contained",children:"Click me"})]})})]})}c.__docgenInfo={description:"",methods:[],displayName:"FirstGuiPreview"};function t(s){const n={br:"br",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Getting Started/Quick Start"}),`
...
`]}),e.jsxs(n.p,{children:["That file demonstrates ",e.jsx(n.code,{children:".me + this.GUI"})," end-to-end with runtime tokens."]})]})]})}function R(s={}){const{wrapper:n}={...l(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t(s)}export{R as default};
