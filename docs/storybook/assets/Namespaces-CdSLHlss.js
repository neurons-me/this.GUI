import{u as t,j as e,M as r}from"./iframe-B26CALAz.js";import"./preload-helper-Dp1pzeXC.js";function s(i){const n={code:"code",em:"em",h2:"h2",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Getting Started/Namespaces"}),`
...
`,e.jsxs(n.p,{children:["Following this model means we are no longer just designing components. We are designing ",e.jsx(n.strong,{children:"a language that renders itself"}),". The UI is simply one dialect of that language."]}),`
`,e.jsx(n.hr,{})]})}function o(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{o as default};
