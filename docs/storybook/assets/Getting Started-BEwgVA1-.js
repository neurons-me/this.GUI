import{j as e,B as s,a as i,u as l,M as c,T as d}from"./iframe-BzW5L-sB.js";import{G as a}from"./GettingStartedHero-B52CUR4c.js";import{S as h}from"./Stack-DvnhhsNE.js";import{B as x}from"./Button-B701r1T7.js";import{Q as p}from"./RouterSemanticsDemos-DKdV_yLh.js";import"./preload-helper-Dp1pzeXC.js";import"./Icon-BWddFN6m.js";import"./getThemeProps-B6mr4j-q.js";import"./Button-DrdkIVvT.js";import"./ButtonBase-DEfx69p-.js";import"./TransitionGroupContext-DBebgn_y.js";import"./useForkRef-BZw98wdx.js";import"./useEventCallback-0bk4YSZd.js";import"./CircularProgress-CqZnmEb2.js";import"./Paper-BNuRA6aQ.js";import"./Paper-rE9EeMCB.js";function o(){return e.jsxs(s,{sx:{mt:2,p:2,border:"1px solid",borderColor:"divider",borderRadius:2,backgroundColor:"background.paper"},children:[e.jsx(i,{variant:"subtitle2",sx:{mb:1,opacity:.78},children:"Rendered output"}),e.jsx(s,{sx:{p:2,borderRadius:2,backgroundColor:"background.default",color:"text.primary"},children:e.jsxs(h,{spacing:1.5,alignItems:"flex-start",children:[e.jsxs(s,{children:[e.jsx(i,{variant:"h4",sx:{fontWeight:700,mb:.5,color:"text.primary"},children:"Hello GUI"}),e.jsx(i,{variant:"body1",sx:{color:"text.primary"},children:"Your first rendered screen"})]}),e.jsx(x,{variant:"contained",children:"Click me"})]})})]})}o.__docgenInfo={description:"",methods:[],displayName:"FirstGuiPreview"};function t(r){const n={br:"br",code:"code",h1:"h1",h2:"h2",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...l(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Getting Started/Quick Start"}),`
`,e.jsx(d,{children:e.jsxs(s,{component:"section",sx:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"44vh",py:4,textAlign:"center"},children:[e.jsx(a,{}),e.jsx(s,{sx:{width:"min(100%, 720px)",mt:4,borderBottom:"1px solid",borderColor:"divider",opacity:.45}})]})}),`
`,e.jsxs(s,{sx:{maxWidth:"960px",mx:"auto",px:{xs:2,md:3},pt:3},children:[e.jsx(n.h1,{id:"start-here-runtime-not-widgets",children:"Start Here: Runtime, Not Widgets"}),e.jsxs(n.p,{children:[e.jsx(n.code,{children:"this.GUI"})," is not only a component catalog.",e.jsx(n.br,{}),`
...
`,e.jsxs(n.li,{children:[e.jsxs(n.strong,{children:["Dynamic tokens (",e.jsx(n.code,{children:"$expr"})," / ",e.jsx(n.code,{children:"$action"}),")"]}),': instead of hardcoding everything, you can say "read this value" or "run this mutation" in a serializable way.']}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"$expr"})," and ",e.jsx(n.code,{children:"$action"})," define ",e.jsx(n.strong,{children:"what should be dynamic"})]}),`
...
`]}),e.jsx(o,{}),e.jsx(n.hr,{}),e.jsx(n.h2,{id:"compose-with-children",children:"Compose With Children"}),e.jsx(n.p,{children:"Everything is just nested nodes."}),e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{
  "type": "Paper",
...
`})}),e.jsx(n.p,{children:"That lets one screen template render many records."}),e.jsx(p,{}),e.jsx(n.hr,{}),e.jsx(s,{sx:{p:2,my:3,bgcolor:"action.hover",borderRadius:1.5,borderLeft:"4px solid",borderColor:"primary.main"},children:e.jsxs(n.p,{children:[e.jsx("strong",{children:"Pro Tip: URL Expression Semantics"}),e.jsx("br",{}),`
...
`]}),e.jsxs(n.p,{children:["That file demonstrates ",e.jsx(n.code,{children:".me + this.GUI"})," end-to-end with runtime tokens."]})]})]})}function S(r={}){const{wrapper:n}={...l(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(t,{...r})}):t(r)}export{S as default};
