import{j as e,L as O,r as w,b as U,R as ne,f as te,k as oe,aw as q}from"./iframe-AZWHUjJ8.js";import{I as C}from"./Icon-FCByiR2v.js";import{M as ae}from"./Menu-B1btoBVS.js";import{M as H}from"./MenuItem-Dd7Uwesr.js";import{Link as se}from"./index-Bk20T6Fy.js";import{u as F}from"./useGuiMediaQuery-Bcjup4L6.js";import{u as ie,a as le}from"./useInsets-B5T9nW_R.js";import{A as pe}from"./Avatar-Bk6cJXvZ.js";import{A as ue}from"./AppBar-BRE8U21k.js";import{T as ce}from"./Toolbar-CufKEqsg.js";const D=({label:i,href:r,icon:o,iconColor:a,external:n,showLabel:l=!0})=>{const s=e.jsxs(e.Fragment,{children:[o&&e.jsx(C,{name:o,iconColor:a||"currentColor",style:{marginRight:3,fontSize:20,position:"relative",top:-1}}),l&&e.jsx("span",{children:i})]});return e.jsx(O,{href:r??"#",target:n?"_blank":"_self",style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none"},children:s})};D.__docgenInfo={description:"",methods:[],displayName:"TopBarLink",props:{label:{required:!0,tsType:{name:"string"},description:""},href:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"string"},description:""},external:{required:!1,tsType:{name:"boolean"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon. Defaults to true.",defaultValue:{value:"true",computed:!1}}}};const V=(i,r,o,a)=>i.map(({label:n,href:l,icon:s,iconColor:h,external:m,items:y},b)=>{const f=n??l??b,u=o.has(n),T=e.jsxs(O,{to:m?void 0:l,href:m?l:void 0,target:m?"_blank":void 0,style:{display:"inline-flex",alignItems:"center",color:"inherit",textDecoration:"none",flexGrow:1},children:[s&&e.jsx(C,{name:typeof s=="string"?s:"info",iconColor:h||"currentColor",style:{marginRight:2,fontSize:20,position:"relative",top:-1}}),n]});return y&&y.length>0?e.jsxs(ne.Fragment,{children:[e.jsxs(H,{onClick:()=>a(n),sx:{color:"inherit",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[T,e.jsx(C,{name:u?"expand_less":"expand_more",iconColor:"currentColor",style:{fontSize:20,position:"relative",top:-1,marginLeft:1}})]}),e.jsx("div",{style:{maxHeight:u?"500px":"0px",opacity:u?1:0,overflow:"hidden",transition:"max-height 0.2s ease-out, opacity 0.2s ease-out",paddingLeft:16},children:V(y,r,o,a)})]},f):e.jsx(H,{onClick:r,sx:{color:"inherit"},children:T},f)}),B=({label:i,icon:r,iconColor:o,items:a,showLabel:n=!0})=>{const[l,s]=w.useState(null),[h,m]=w.useState(new Set),y=u=>{s(u.currentTarget)},b=()=>{s(null),m(new Set)},f=u=>{m(T=>{const v=new Set(T);return v.has(u)?v.delete(u):v.add(u),v})};return e.jsxs(e.Fragment,{children:[e.jsxs(U,{onClick:y,sx:{cursor:"pointer",px:1,display:"inline-flex",alignItems:"center",color:"inherit"},children:[r&&e.jsx(C,{name:typeof r=="string"?r:"info",iconColor:o||"currentColor",style:{marginRight:n?2:0,fontSize:20,position:"relative",top:-1}}),n&&e.jsx("span",{children:i})]}),e.jsx(ae,{anchorEl:l,open:!!l,onClose:b,sx:{color:"inherit"},children:a&&V(a,b,h,f)})]})};B.__docgenInfo={description:"",methods:[],displayName:"TopBarMenu",props:{label:{required:!0,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},iconColor:{required:!1,tsType:{name:"string"},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:"Whether to display the label next to the icon in the top-level menu trigger. Defaults to true.",defaultValue:{value:"true",computed:!1}},items:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  href: string;
  icon?: ReactNode;
  iconColor?: string;
